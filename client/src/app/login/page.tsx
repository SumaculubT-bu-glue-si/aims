      ...
      <Card className="w-full max-w-sm">
        ...
        <CardContent>
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            {loading || isSubmitting ? 'Signing in...' : t('pages.login.login_button')}
          </Button>
        </form>
          ...
          <Button variant="outline" onClick={signInWithGoogle} className="w-full" disabled={loading || isSubmitting}>
            ...
            {loading || isSubmitting ? 'Signing in...' : t('pages.login.button')}
          </Button>
        </CardContent>
      </Card>
    </div>
